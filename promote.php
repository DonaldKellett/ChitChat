...
<html>
  <head>
    <meta charset="utf-8">
    <title>Promote User - ChitChat by DonaldKellett</title>
                    ...
                    if ($my_acc['rank'] > $other_acc['rank']) {
                      if ($other_acc['rank'] < 4) {
                        ...
                        if ($conn->query("UPDATE accounts SET rank = " . $new_rank . " WHERE username = " . htmlspecialchars_decode("&quot;") . $other_acc['username'] . htmlspecialchars_decode("&quot;") . ";")) { ?>
                          ...
                          <p>
                            The action was successful and the user selected now has a higher rank.
                          </p>
                          <p>
...
<pre><code><?php echo $conn->error; ?></code></pre>
                        ...
                        <h2>Action Denied</h2>
                        <p>
                          Sorry, you may not promote anyone who is already a Super Moderator or above.  This is to prevent any accidental promotions of Super Moderators to Administrators which then cannot be undone.
                        </p>
                        <p>
                          If you would like to promote a Super Moderator to Administrator rank, please contact the <a href="mailto:dleung@connect.kellettschool.com">owner of the website</a>.  Upon confirmation, the owner of this website/Service will manually promote said Super Moderator.
                        </p>
                        <p>
